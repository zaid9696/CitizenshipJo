...
<main class="content">
    <h2 class="content__title">Programs</h2>
    ...
    <button class="content__btn"><a href="<?php echo site_url('/en/category/programs/')?>">View more</a></button>
</main>
